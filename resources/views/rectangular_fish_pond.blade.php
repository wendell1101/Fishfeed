...
<div class="container mt-3">
  <div class="form-group">
    ...
    <a href="{{route('round_fish_pond')}}" class="btn btn-secondary mt-2 mr-2">Nile/ Red Tilapia Circular Fish Tank Grow-out Requirement Guide</a>
    <a href="{{route('rectangular_fish_pond')}}" class="btn btn-success mt-2 mr-2">Nile/ Red Tilapia Earthen Pond Grow-out Requirement Guide</a>
  </div>
</div>
<div class="container">
