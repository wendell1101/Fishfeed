...
class MonitoringController extends Controller
{
    ...
    {
        $users = User::all();
        return view('admin.monitorings.index', compact('users'));
    }

    public function monitoringPerUser(Request $request, User $user)
    {
        $userId = $user->id;
        ...
        return view('admin.monitorings.show', compact('data','user'));
    }
}
